...
<div class="container" id="cookies-disabled-popup">
    ...
    <p>Chúng tôi sử dụng Cookies nhằm mục đích bảo mật và để định danh phiên làm việc của bạn.
        Bạn có thể tắt Cookies trong cài đặt của trình duyệt. Tuy nhiên chúng tôi không đảm bảo việc trang
        web của chúng tôi sẽ hoạt động hiệu quả nếu không bật Cookies. Cảm ơn bạn đã lắng nghe!</p>
    <br>
