...
-- Film
insert into filmbooking.films (film_id, film_name, film_price, film_director, film_cast, film_length, film_description, film_trailer_link, img_path, slug) values (1, 'Oppenheimer', 85000, 'Christopher Nolan', 'Cillian Murphy, Emily Blunt, Matt Damon, Robert Downey Jr., Florence Pugh, Josh Hartnett, Casey Affleck, ...', 180, '“Oppenheimer” là một bộ phim điện ảnh tiểu sử, tái hiện câu chuyện có thật về quá trình tạo ra bom nguyên tử - thứ vũ khí huỷ diệt đã được thả xuống Hiroshima và Nagasaki, Nhật Bản vào năm 1945. Bộ phim đặt ra những câu hỏi, cũng chính là những băn khoăn mà các nhà khoa học đã đưa ra vào thời điểm đó về quyền lực, đạo đức và tham vọng.
<br>
<br>
...
insert into filmbooking.films (film_id, film_name, film_price, film_director, film_cast, film_length, film_description, film_trailer_link, img_path, slug) values (2, 'The Zone of Interest', 120000, 'Jonathan Glazer', 'Christian Friedel, Sandra Hüller,...', 150, 'The Zone of Interest là một bộ phim lịch sử kinh điển, khắc họa cuộc sống đầy bi kịch và mâu thuẫn của những người tham gia vào hệ thống tàn sát của Đức Quốc Xã. Phim dựa trên tiểu thuyết cùng tên của Martin Amis, một trong những nhà văn hiện đại nổi tiếng nhất thế giới. Phim được đạo diễn bởi Florian Henckel von Donnersmarck, người đã từng đoạt giải Oscar với bộ phim The Lives of Others.
<br><br>
...
-- Film Genre
insert into filmbooking.film_genres (film_id, genre_id)
values  (4, 'haikich'),
        (5, 'haikich'),
        (6, 'haikich'),
        (7, 'haikich'),
